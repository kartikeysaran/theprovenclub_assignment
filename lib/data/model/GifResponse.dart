class GiphyResponse {
  ...
  GiphyResponse({List<Data>? data, Meta? meta, Pagination? pagination}) {
    if (data != null) {
      this._data = data;
    }
    if (meta != null) {
...
class Data {
  ...
  set importDatetime(String? importDatetime) =>
      _importDatetime = importDatetime;
  String? get trendingDatetime => _trendingDatetime;
  set trendingDatetime(String? trendingDatetime) =>
      _trendingDatetime = trendingDatetime;
  Images? get images => _images;
  set images(Images? images) => _images = images;
  User? get user => _user;
  set user(User? user) => _user = user;
  String? get analyticsResponsePayload => _analyticsResponsePayload;
  set analyticsResponsePayload(String? analyticsResponsePayload) =>
      _analyticsResponsePayload = analyticsResponsePayload;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    _analytics = json['analytics'] != null
...
class Images {
  ...
  set downsizedLarge(Downsized? downsizedLarge) =>
      _downsizedLarge = downsizedLarge;
  Downsized? get downsizedMedium => _downsizedMedium;
  set downsizedMedium(Downsized? downsizedMedium) =>
      _downsizedMedium = downsizedMedium;
  DownsizedSmall? get downsizedSmall => _downsizedSmall;
  set downsizedSmall(DownsizedSmall? downsizedSmall) =>
      _downsizedSmall = downsizedSmall;
  Downsized? get downsizedStill => _downsizedStill;
  set downsizedStill(Downsized? downsizedStill) =>
      _downsizedStill = downsizedStill;
  ...
  set fixedHeightDownsampled(FixedHeightDownsampled? fixedHeightDownsampled) =>
      _fixedHeightDownsampled = fixedHeightDownsampled;
  FixedHeight? get fixedHeightSmall => _fixedHeightSmall;
  set fixedHeightSmall(FixedHeight? fixedHeightSmall) =>
      _fixedHeightSmall = fixedHeightSmall;
  Downsized? get fixedHeightSmallStill => _fixedHeightSmallStill;
  set fixedHeightSmallStill(Downsized? fixedHeightSmallStill) =>
      _fixedHeightSmallStill = fixedHeightSmallStill;
  Downsized? get fixedHeightStill => _fixedHeightStill;
  set fixedHeightStill(Downsized? fixedHeightStill) =>
      _fixedHeightStill = fixedHeightStill;
  ...
  set fixedWidthDownsampled(FixedHeightDownsampled? fixedWidthDownsampled) =>
      _fixedWidthDownsampled = fixedWidthDownsampled;
  FixedHeight? get fixedWidthSmall => _fixedWidthSmall;
  set fixedWidthSmall(FixedHeight? fixedWidthSmall) =>
      _fixedWidthSmall = fixedWidthSmall;
  Downsized? get fixedWidthSmallStill => _fixedWidthSmallStill;
  set fixedWidthSmallStill(Downsized? fixedWidthSmallStill) =>
      _fixedWidthSmallStill = fixedWidthSmallStill;
  Downsized? get fixedWidthStill => _fixedWidthStill;
  set fixedWidthStill(Downsized? fixedWidthStill) =>
      _fixedWidthStill = fixedWidthStill;
...
class DownsizedSmall {
  ...
  DownsizedSmall(
      {String? height, String? width, String? mp4Size, String? mp4}) {
    if (height != null) {
      this._height = height;
    }
    if (width != null) {
...
class Pagination {
  ...
  Pagination({int? totalCount, int? count, int? offset}) {
    if (totalCount != null) {
